            ...
            if(1): #self.readingNow == False):
                while(1):
                    ...
                    if phPtCal == -1:
                        ...
                        self.screen.drawText("Single point", 18, color, self.screen.middleBtn, 0, 0)
                        self.screen.drawText("Two point", 18, color, self.screen.btmLeft, 0, 0)
                        self.screen.drawText("Three point", 18, color, self.screen.btmRight, 0, 0)
                    else:
                                    ...
                                    if phPtCal == -1:
                                        if self.screen.btmRight.collidepoint(event.pos):
                                            ...
                                            if phStepNum == -1:
                                                    ...
                                                    self.canvas.fill((0,0,0))        
                                                    self.screen.drawText("Calibrate", 18, color, self.screen.btmRight, 0, 0)
                                                    self.screen.drawText("1. Remove cap, rinse probe", 15, color, self.screen.topLeft, 70, -30)
                                                    self.screen.drawText("2. Pour solution in cup", 15, color, self.screen.topLeft, 70, -10)
                                                    self.screen.drawText("3. Sit probe in solution 1-2 min", 15, color, self.screen.topLeft, 70, 10)
                                                    self.screen.drawText("4. Press the Calibrate button", 15, color, self.screen.topLeft, 70, 30)
                                                    pg.display.update()
                                            elif phStepNum == 1:
                                                ...
                                                if super().tryThree('CAL,mid,' + str(midPt)):
                                                    ...
                                                    self.canvas.fill((0,0,0))
                                                    self.screen.drawText("Calibrate", 18, color, self.screen.btmRight, 0, 0)
                                                    self.screen.drawText("1. Rinse off pH probe", 15, color, self.screen.topLeft, 70, -30)
                                                    self.screen.drawText("2. Pour solution in cup", 15, color, self.screen.topLeft, 70, -10)
                                                    self.screen.drawText("3. Sit probe in solution 1-2 min", 15, color, self.screen.topLeft, 70, 10)
                                                    self.screen.drawText("4. Press the Calibrate button", 15, color, self.screen.topLeft, 70, 30)
                                            elif phStepNum == 3:
